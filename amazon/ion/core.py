    ...
    def __eq__(self, other):
        ...
        if isinstance(self.value, float):
            ...
            if isinstance(self.value, Timestamp) or isinstance(other.value, Timestamp):
                ...
                self_microseconds = getattr(other.value, MICROSECONDS, None)
...
class Timestamp(datetime):
    ...
    """
    __slots__ = [TIMESTAMP_PRECISION_FIELD, TIMESTAMP_FRACTION_PRECISION_FIELD, MICROSECONDS]
    ...
    def __new__(cls, *args, **kwargs):
        ...
        if MICROSECONDS in kwargs:
            microseconds = kwargs.get(MICROSECONDS)
            # Make sure we mask this before we construct the datetime.
        ...
        setattr(instance, MICROSECONDS, microseconds)
...
def timestamp(year, month=1, day=1,
              ...
              precision=None, fractional_precision=None, microseconds=None):
    ...
    return Timestamp(
        ...
        tz, precision=precision, fractional_precision=fractional_precision, microseconds=microsecond
    )
